<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
    <form class="p-4">
        ...
        <div class="relative z-0 w-full mb-6 group">
            <input type="text" id="myInput2" wire:model='description'
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " value="{{ $rol->description }}" required />
        ...
        <x-primary-button id="myButton" type="submit" wire:click.prevent="edit({{ $rol->id }})"
            wire:loading.attr="disabled" disabled>
            Editar rol <i class="fa-solid fa-pencil"></i>
        </x-primary-button>
    </form>
    <script>
